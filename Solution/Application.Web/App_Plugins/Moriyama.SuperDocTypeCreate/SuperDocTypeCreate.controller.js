/**
 * @ngdoc controller
 * @name Umbraco.Editors.DocumentType.SuperCreateController
 * @function
 *
 * @description
 * The controller for the doc type creation dialog
 */
function DocumentTypesSuperCreateController($scope, $location, navigationService, contentTypeResource, formHelper, appState, notificationsService, localizationService, iconHelper) {
...
angular.module('umbraco').controller("Umbraco.Editors.DocumentTypes.SuperCreateController", DocumentTypesSuperCreateController);